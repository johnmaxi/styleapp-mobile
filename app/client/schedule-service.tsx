...
import { SERVICE_CATALOG, ProfessionalType, formatPrice } from "@/constants/services";
...
export default function ScheduleService() {
  ...
  return (
    <ScrollView contentContainerStyle={{
          ...
          return (
            ...
            >
              <View style={{
                ...
                borderWidth: 2, borderColor: selected ? palette.primary : "#555",
                backgroundColor: selected ? palette.primary : "transparent",
                alignItems: "center", justifyContent: "center",
              }}>
                {selected && <Text style={{ color: "#000", fontSize: 12, fontWeight: "900" }}>✓</Text>}
              </View>
              <View style={{ flex: 1 }}>
                <Text style={{ color: palette.text, fontWeight: "700" }}>{svc.label}</Text>
      ...
      {/* Fecha */}
      <Text style={{ color: palette.primary, fontWeight: "700", fontSize: 15, marginTop: 8 }}>
        ¿Qué día?
      </Text>
            ...
            return (
              <TouchableOpacity
                ...
                style={{
                  ...
                  borderWidth: 1, borderColor: selected ? palette.primary : "#333",
                  minWidth: 64,
                }}
              >
                <Text style={{ color: selected ? "#000" : "#888", fontSize: 11 }}>
                  {DAY_NAMES[d.getDay()]}
                </Text>
                <Text style={{ color: selected ? "#000" : palette.text, fontWeight: "900", fontSize: 18 }}>
                  {d.getDate()}
                </Text>
                <Text style={{ color: selected ? "#000" : "#888", fontSize: 11 }}>
          ...
          return (
            <TouchableOpacity
              ...
              style={{
                ...
                borderWidth: 1, borderColor: sel ? palette.primary : "#333",
              }}
            >
              <Text style={{ color: sel ? "#000" : palette.text, fontWeight: sel ? "900" : "400" }}>
                {h}
              </Text>
            </TouchableOpacity>
          );
      ...
      <TextInput
        ...
        multiline
        style={{
          backgroundColor: palette.card, borderRadius: 10, padding: 14,
          color: palette.text, borderWidth: 1, borderColor: "#333",
      ...
      {selectedDate && selectedHour && (
        <View style={{
          ...
          borderWidth: 1, borderColor: "#2196F3", gap: 6,
        }}>
          <Text style={{ color: "#2196F3", fontWeight: "900" }}>📅 Resumen del agendamiento</Text>
